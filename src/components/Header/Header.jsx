...
const Header = () => {
  return (
    <div className='min-h-screen mb-4 bg-cover bg-centre flex items-center w-full overflow-hidden ' 
    ...
    lg:px-32 text-white'>
        ...
        <div className='space-x-6 mt-16'>
            <a href="#Projects" className='bg-orange-500 px-8
            py-3 roundend'>Projects</a>
            <a href="#Contact"className='bg-blue-500 px-8
            py-3 roundend'>Contact Us</a>
        </div>
    </motion.div>
    </div>
